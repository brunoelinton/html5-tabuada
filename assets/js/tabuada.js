...
// Declaração da função que realiza o cálcula da tabuada
function calculaTabuada() {
    // Obtendo do DOM o tbody da tabela
    let tabuada = document.querySelector('#tabuada tbody');
    // Obtendo o valorA do campo input numbere convertendo em inteiro
    ...
    for (let valorB = 0; valorB <= 10; valorB++) {
        ...
        // Criando os templates das colunas da linha atual
        let template = `
            <td>${valorA}</td>
            <td>x</td>
            <td>${valorB}</td>
